...
export default function ConfigDiffViewer({ title, entries, onApply, onCancel, applyLabel = 'Aplicar cambios' }: Props) {
      ...
      >
        ...
        >
          <div>
            ...
            >
              {entries.length} {entries.length === 1 ? 'campo' : 'campos'} cambiados
            </span>
          </div>
          <button
            onClick={onCancel}
        ...
        >
          <div className="px-3 py-2 text-ark-cyan/40">Campo</div>
          <div
